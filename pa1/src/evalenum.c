...
// TODO: quicksort partition using median of 3
void partition3(int * A, int l, int r, int *i, int *j, sortperf_t *s) {
}

// TODO: standard quicksort partition
void partition(int * A, int l, int r, int *i, int *j, sortperf_t *s) {
}

// TODO: standard quicksort
void quickSort(int * A, int l, int r, sortperf_t *s) { 
}

// TODO: quicksort with median of 3
void quickSort3(int * A, int l, int r, sortperf_t *s) { 
}

// TODO: quicksort with insertion for small partitions
void quickSortIns(int * A, int l, int r, sortperf_t *s) { 
}

// TODO: quicksort with insertion for small partitions and median of 3
...
int main (){
  ...
  int array[10] = {8,0,4,1,6,2,3,5,9,7};

  sortperf_t s;

  printVector(array, 10);

  selectionSort(array, 0, 10, &s);
